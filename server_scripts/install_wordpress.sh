...
#TODO: add Wordfence plugin automatically, and setup waf.php code and php.ini code
...
/** update themes, plugings directly via file system, not FTP */
...
#paste in this php.ini file (long)
sudo cat > /etc/php/7.0/apache2/php.ini <<EOF
[PHP]
